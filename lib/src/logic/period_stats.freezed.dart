...
@override
int get hashCode => Object.hash(runtimeType,categoryId,name,type,limit,totalSpent,totalPlanned,remaining,heatPercentage,isOverBudget,isDailyAllowance,plannedExceedsLimit,const DeepCollectionEquality().hash(plannedExpenseStatuses),dailyAllowanceAmount,trend,basket);

@override
String toString() {
  return 'CategoryStats(categoryId: $categoryId, name: $name, type: $type, limit: $limit, totalSpent: $totalSpent, totalPlanned: $totalPlanned, remaining: $remaining, heatPercentage: $heatPercentage, isOverBudget: $isOverBudget, isDailyAllowance: $isDailyAllowance, plannedExceedsLimit: $plannedExceedsLimit, plannedExpenseStatuses: $plannedExpenseStatuses, dailyAllowanceAmount: $dailyAllowanceAmount, trend: $trend, basket: $basket)';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String categoryId,  String name,  CategoryType type,  double limit,  double totalSpent,  double totalPlanned,  double remaining,  double heatPercentage,  bool isOverBudget,  bool isDailyAllowance,  bool plannedExceedsLimit,  List<PlannedExpenseStatus> plannedExpenseStatuses,  double? dailyAllowanceAmount,  SpendingTrend? trend,  BasketAdvice? basket)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CategoryStats() when $default != null:
return $default(_that.categoryId,_that.name,_that.type,_that.limit,_that.totalSpent,_that.totalPlanned,_that.remaining,_that.heatPercentage,_that.isOverBudget,_that.isDailyAllowance,_that.plannedExceedsLimit,_that.plannedExpenseStatuses,_that.dailyAllowanceAmount,_that.trend,_that.basket);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String categoryId,  String name,  CategoryType type,  double limit,  double totalSpent,  double totalPlanned,  double remaining,  double heatPercentage,  bool isOverBudget,  bool isDailyAllowance,  bool plannedExceedsLimit,  List<PlannedExpenseStatus> plannedExpenseStatuses,  double? dailyAllowanceAmount,  SpendingTrend? trend,  BasketAdvice? basket)  $default,) {final _that = this;
switch (_that) {
case _CategoryStats():
return $default(_that.categoryId,_that.name,_that.type,_that.limit,_that.totalSpent,_that.totalPlanned,_that.remaining,_that.heatPercentage,_that.isOverBudget,_that.isDailyAllowance,_that.plannedExceedsLimit,_that.plannedExpenseStatuses,_that.dailyAllowanceAmount,_that.trend,_that.basket);}
}
...
@override@JsonKey() final  bool plannedExceedsLimit;
...
@override
int get hashCode => Object.hash(runtimeType,categoryId,name,type,limit,totalSpent,totalPlanned,remaining,heatPercentage,isOverBudget,isDailyAllowance,plannedExceedsLimit,const DeepCollectionEquality().hash(_plannedExpenseStatuses),dailyAllowanceAmount,trend,basket);
...
@override $SpendingTrendCopyWith<$Res>? get trend;@override $BasketAdviceCopyWith<$Res>? get basket;
