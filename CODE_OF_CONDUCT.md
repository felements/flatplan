...
This Code of Conduct applies within all project spaces and when an individual is officially representing the project in public spaces (e.g., using an official project email address or posting via an official social media account).
...
**1. Correction** — Private written warning and clarification of the violation.  
**2. Warning** — A formal warning with consequences for continued behaviour.  
**3. Temporary Ban** — Temporary suspension from community interaction.  
**4. Permanent Ban** — Permanent exclusion from all community interaction.
