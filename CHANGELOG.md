...
- Period creation moved out of Settings: a "+ Next period" button under Today in the sidebar creates the first period of an empty vault or rolls the current one over. The dashboard's empty state opens the same dialog directly.
