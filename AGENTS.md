...
- `lib/src/views/` — `DashboardView`, `CategoryDetailView`, `CategoryEditorView`, `SettingsView`, `AppShell`, `VaultListView`, `VaultFormView`, and the `vault_kinds.dart` descriptor list
